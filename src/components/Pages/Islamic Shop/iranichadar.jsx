...
const IraniChadar = () => {
  const breadcrumbItems = [
    ...
    { label: "Namaz Chadar", active: true },
  ];

  return (
    <div>
      <PageHeader title="Namaz Chadar" breadcrumbItems={breadcrumbItems} />
      <div className="container py-5">
        <div className="text-center wow fadeInUp" data-wow-delay="0.1s">
          <h6 className="section-title bg-white text-center text-primary px-3">
            Product
          </h6>
          <h2 className="mb-4">Namaz Chadar Collection</h2>
        </div>
        <p>
          The Namaz Chadar is a beautifully designed traditional garment widely
          ...
          prayer, religious gatherings, and various cultural events. The Namaz
        ...
        <p>
          ...
          coverage while remaining stylish and lightweight. Namaz Chadar is also
        ...
        <p>
          The Namaz Chadar comes in various colors, patterns, and styles to
          ...
          Namaz Chadar serves as a perfect choice for women seeking elegance and
          comfort.
        </p>
        <p>
          We offer a range of Namaz Chadar garments that are carefully crafted
          ...
          addition to your wardrobe, the Namaz Chadar is the ideal choice.
        </p>
      </div>
      ...
      <div className="container py-5">
        <div className="row">
          ...
          <div className="col-md-6">
            <h4>Why Choose Our Namaz Chadar?</h4>
            <ul>
      ...
      <div className="container py-5">
        <div className="text-center">
          ...
          <p>Here's what our customers say about our Namaz Chadar:</p>
        </div>
        <div className="row">
            ...
            <div className="card">
              <div className="card-body">
                <p className="card-text">
                  "I bought the Namaz Chadar for a family event, and it was
          ...
          <div className="col-md-4">
            <div className="card">
              <div className="card-body">
                <p className="card-text">
                  "The Namaz Chadar is elegant and breathable. I wore it during
          ...
          <div className="col-md-4">
            <div className="card">
              <div className="card-body">
                <p className="card-text">
                  "Such a beautiful piece! I love how versatile the Namaz Chadar
